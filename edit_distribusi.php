...
<h3>DATA LOGISTIK LEMBAR KERJA SISWA</h3>
    ...
    <h4>DISTRIBUSI LKS</h4>
      ...
      <input id="nama" type="text" name="nama" required placeholder="Masukan Nama Sekolah" value="<?php print($row['nama_sekolah']) ?>">
...
<?php 
    ...
    if(isset($_POST['submit'])){
        $data = $_POST;
        $sql = "update distribusi set nama_sekolah = '$data[nama]', kelas='$data[kelas]', jumlah ='$data[jumlah]' where id = $id";
